...
namespace testing::expat
{
    using observer_t = kmx::test<>::observer_t;
    observer_t* observer {};
    ...
    class test: public kmx::test<>
    {
    public:
        test(const char* data_path): kmx::test<>("expat", data_path) {}
